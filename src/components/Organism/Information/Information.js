        ...
        <div className={styles.content}>
            ...
            >
              <ul className={styles.animated}>
                <li>
                  ...
                  <p>
                    El CM crea y gestiona una identidad y comunidad digital.
                  </p>
                </li>
                <li>
                  <span>
                  ...
                  <p>
                    Escucha cuáles son las necesidades de los usuarios para
                    saber que quieren y así llegar a construir una relación más
                    cercana con el.
                  </p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p>
                    Analiza las nuevas tendencias para incorporar al contenido.
                  </p>
                </li>
                <li>
                  <span>
                  ...
                  <p>
                    Acorta el tiempo de respuesta de comentarios y mensajes de
                    los usuarios
                  </p>
                </li>
              </ul>
          ...
          <Controller>
            <Scene
              ...
              classToggle={`fade-in`}
            >
              <ul className={styles.animated2}>
                <li>
                  <span>
                    <Image src={heart} alt="heart" width={24} height={24} />
                  </span>
                  <p>
                    Dedica tiempo diario para interactuar y darle uso a la
                    cuenta
                  </p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p>
                    Escribe no más de 4 o 5 hashtag relacionados a tu contenido
                  </p>
                </li>
                <li>
                  <span>
